...
* 对于 E-UTRAN 和 通用non-3GPP 接入网络之间的系统间移动性，包括一些特定 NAS 流程，用于在使用基于双栈移动IPv6 的移动性管理时保持与 PDN 网关的 IP 连接并提供 UE 所需的参数（参见 3GPP TS 24.303 \[14]）或 MIPv4（参见 3GPP TS 24.304 \[15]）。
