...
* 在当前文档定义的 NAS 协议和 3GPP TS 24.008 \[13] （适用于 GERAN 和 UTRAN）、3GPP TS 24.501 [54](适用于 NG-RAN )中规定的 NAS 协议所使用的参数和流程之间的映射规则，以及 。用于E-UTRAN 和 GERAN、UTRAN 或 NG-RAN 之间的系统间移动性。
