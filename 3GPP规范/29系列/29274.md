...
通常，Request消息是Initial消息，但在某些流程中，Request消息可能是Triggered消息，由Initial Command消息触发。关于Initial消息及其可能Triggered消息的分类，以及对Triggered消息有Triggered Reply消息的情况，请参见第4.2.5条。
