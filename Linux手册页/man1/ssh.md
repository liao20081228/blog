...
ssh \[-46AaCfGgKkMNnqsTtVvXxYy] \[-B <u>bind_interface</u>] \[-b bind_address] \[-c cipher_spec] \[-D \[bind_address:]port] \[-E log_file] \[-e escape_char] \[-F configfile] \[-I pkcs11] \[-i identity_file]
           \[-J  destination]  \[-L  address]  \[-l  login_name]  \[-m  mac_spec]  \[-O  ctl_cmd]  \[-o  option] \[-P tag] \[-p port] \[-R address] \[-S ctl_path] \[-W host:port] \[-w local_tun\[:remote_tun]] destination \[command \[argument ...]]
