...
***<font color=blue>版权声明：</font>本文翻译自<font color=blue>[《Linux man-pages》](https://www.kernel.org/doc/man-pages/)》。</font>版本为V6.7，手册更新时间为2023-10。<font color=red>本文与原始文档采用相同的版权许可。</font><font color=blue>转载请注明出处！！！</font>***
